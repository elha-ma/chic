...
if ( is_home() ) {
	...
	<div id="chic-products"  class="boxed-wrapper clear-fix">
		...
		<!--SEO: On a remplacé ce h1 par h2, car il y a déjà un h1 sur la page et on rajouté un mot clé
		<h1 class="chic-title">Dernières pièces </h1>-->
		<h2 class="chic-title">Dernières pièces de créateur</h2>
	...
	<div id="chic-fashionweek-map" class="boxed-wrapper clear-fix" style="margin-top:30px">
		<!-- SEO: on a mis h2 à la place de h1 -->
		<h2 class="chic-title">La FashionMap - été 2022 - marques de luxe </h2>
		<!--SEO: Ajouter Nom de iframe et l'option defer -->
		<iframe defer src="https://www.google.com/maps/d/embed?mid=1SU-W19k76UkTXASeT7PnGAyDYCY&hl=en_US&ehbc=2E312F" width="100%" height="480" title="GoogleMap" name="Google Map"></iframe>';
	</div>
	<?php
